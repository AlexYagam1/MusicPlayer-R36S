...
GAMEDIR=/$directory/ports/YourGame #Switch "YourGame" for the folder
godot_runtime="godot_4.4" 
godot_executable="godot44.$DEVICE_ARCH"
pck_filename="YourGame.pck" #Switch "YouGame" for the pck name
gptk_filename="base.gptk" #Switch "base" for the gptk map name
